...
// ─── Hotels ────────────────────────────────────────────────────────────────
function nt_section_hotels_fields(): array {
  $k = 'fld_hotels_';
  return [
    nt_field_title($k),
    nt_field_lead($k),
    ...
    nt_field_link($k, 'כפתור — לכל המלונות', 'cta'),
  ];
}
...
function nt_section_registry(): array {
  return [
    ...
    'attractions'         => ['Attractions',         'nt_section_attractions_fields'],
    'destinations'        => ['Destinations',        'nt_section_destinations_fields'],
    'hotels'              => ['Hotels',              'nt_section_hotels_fields'],
    'use_cases'           => ['Use Cases',           'nt_section_use_cases_fields'],
